package com.exa.mydemoapp.viewer;
    ...
    public void logoOut() {
        ...
        try {
            ...
            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    CommonUtils.removeAllPref(com.exa.mydemoapp.viewer.HomeActivity.this);
                    Intent intent = new Intent(com.exa.mydemoapp.viewer.HomeActivity.this, LoginActivity.class);
                    startActivity(intent);
                    finish();
                }
            }).setNegativeButton("No", new DialogInterface.OnClickListener() {
