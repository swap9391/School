...
public class DriverListFragment extends CommonFragment {
    ...
    public DriverListFragment(List<UserModel> driverList) {
    ...
    private void initAdapter() {
        mAdapter = new UserAdapter(driverList, getMyActivity());
