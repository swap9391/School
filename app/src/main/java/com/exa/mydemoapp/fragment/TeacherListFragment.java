...
public class TeacherListFragment extends CommonFragment {
    ...
    public TeacherListFragment(List<UserModel> teacherList) {
    ...
    private void initAdapter() {
        ...
        mAdapter = new UserAdapter(teacherList, getMyActivity());
