...
public class AdminListFragment extends CommonFragment {
    ...
    public AdminListFragment(List<UserModel> adminList) {
    ...
    private void initAdapter() {
        ...
        mAdapter = new UserAdapter(adminList, getMyActivity());
